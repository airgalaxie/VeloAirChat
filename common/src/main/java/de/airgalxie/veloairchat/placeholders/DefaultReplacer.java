...
package de.airgalxie.veloairchat.placeholders;
...
public class DefaultReplacer implements PlaceholderReplacer {
    ...
    public DefaultReplacer(@NotNull VeloAirChat plugin) {
        this.plugin = plugin;
    }
    ...
    public enum Placeholder {
         ...
         */
        private final BiFunction<VeloAirChat, OnlineUser, String> replacer;
        private final Set<String> aliases = new HashSet<>();

        Placeholder(@NotNull BiFunction<VeloAirChat, OnlineUser, String> replacer, @NotNull String... aliases) {
         ...
         * @param plugin The VeloAirChat plugin instance
         * @param player The player to replace placeholders for
         * @return The string with placeholders replaced
         */
        private static CompletableFuture<String> replace(@NotNull String format, @NotNull VeloAirChat plugin, @NotNull OnlineUser player) {
        ...
        // Keep the historical underscore escape for existing placeholder output.
        @NotNull
