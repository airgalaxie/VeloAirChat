...
package de.airgalxie.veloairchat.user;
...
public class UserCache {
    ...
    @NotNull
    public Map<OnlineUser, SpyColor> getSocialSpies(@NotNull List<OnlineUser> recipients, @NotNull VeloAirChat plugin) {
    ...
    @NotNull
    public Map<OnlineUser, SpyColor> getLocalSpies(@NotNull String server, @NotNull VeloAirChat plugin) {
        final Map<OnlineUser, SpyColor> receivers = new LinkedHashMap<>();
    ...
    public static class Editor extends UserCache {
         ...
         */
        public void switchPlayerChannel(@NotNull OnlineUser user, @NotNull String channelId, @NotNull VeloAirChat plugin) {
            switchPlayerChannel(user, channelId, plugin, true);
        }

        /**
         * Switch the {@link OnlineUser}'s channel without sending feedback.
         *
         * @param user    {@link OnlineUser} to switch the channel of
         * @param channelId ID of the channel to switch to
         * @param plugin the plugin instance
         */
        public void switchPlayerChannelSilently(@NotNull OnlineUser user, @NotNull String channelId,
                                                @NotNull VeloAirChat plugin) {
            switchPlayerChannel(user, channelId, plugin, false);
        }

        private void switchPlayerChannel(@NotNull OnlineUser user, @NotNull String channelId,
                                         @NotNull VeloAirChat plugin, boolean notify) {
