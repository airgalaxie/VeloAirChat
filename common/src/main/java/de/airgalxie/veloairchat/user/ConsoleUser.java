...
public class ConsoleUser extends OnlineUser {
    ...
    private ConsoleUser(@NotNull VeloAirChat plugin) {
     ...
     *
     * @param plugin The implementing VeloAirChat plugin
     * @return The ConsolePlayer
     */
    @NotNull
    public static ConsoleUser wrap(@NotNull VeloAirChat plugin) {
