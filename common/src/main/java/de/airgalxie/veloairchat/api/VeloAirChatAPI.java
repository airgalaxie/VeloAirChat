...
import de.airgalxie.veloairchat.message.BroadcastMessage;
import de.airgalxie.veloairchat.message.ChatMessage;
import de.airgalxie.veloairchat.message.PrivateMessage;
...
public class VeloAirChatAPI {
    protected static VeloAirChatAPI instance;
    protected final VeloAirChat plugin;

    protected VeloAirChatAPI(@NotNull VeloAirChat plugin) {
        this.plugin = plugin;
    }

    @NotNull
    public static VeloAirChatAPI getInstance() {
        return instance;
    }
