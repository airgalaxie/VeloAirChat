...
import de.airgalaxie.veloairchat.util.MessageFormatter;
...
public abstract class OnlineUser extends User {
    ...
    protected VeloAirChat plugin;

    protected OnlineUser(@NotNull String username, @NotNull UUID uuid, @NotNull VeloAirChat plugin) {
        super(username, uuid);
        this.plugin = plugin;
    }
    ...
    public void sendMessage(@NotNull String message) {
        sendMessage(MessageFormatter.format(message, getAudience(), plugin.getFormattingTagResolver()));
    }
}
