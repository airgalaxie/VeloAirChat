Group Messages are a unique feature of VeloAirChat that lets you send messages to a group of players, instead of just a single player. This is really useful for parties of players working together on group projects.
