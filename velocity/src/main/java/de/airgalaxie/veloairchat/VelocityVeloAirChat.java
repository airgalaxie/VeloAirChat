...
import de.airgalaxie.veloairchat.api.VelocityVeloAirChatAPI;
import de.airgalaxie.veloairchat.bridge.VelocityBackendBridge;
import de.airgalaxie.veloairchat.command.ShortcutCommand;
import de.airgalaxie.veloairchat.command.VelocityCommand;
import de.airgalaxie.veloairchat.config.Channels;
import de.airgalaxie.veloairchat.config.Filters;
import de.airgalaxie.veloairchat.config.Locales;
import de.airgalaxie.veloairchat.config.Settings;
import de.airgalaxie.veloairchat.event.VelocityEventProvider;
import de.airgalaxie.veloairchat.filter.ChatFilter;
import de.airgalaxie.veloairchat.getter.DataGetter;
import de.airgalaxie.veloairchat.getter.DefaultDataGetter;
import de.airgalaxie.veloairchat.getter.LuckPermsDataGetter;
import de.airgalaxie.veloairchat.listener.VelocityEventChatListener;
import de.airgalaxie.veloairchat.listener.VelocityPacketChatInterceptor;
import de.airgalaxie.veloairchat.listener.VelocityPlayerListener;
import de.airgalaxie.veloairchat.moderation.ChatModerationPipeline;
import de.airgalaxie.veloairchat.moderation.CompositeChatAnalyzer;
import de.airgalaxie.veloairchat.moderation.StandardDecisionEngine;
import de.airgalaxie.veloairchat.moderation.analyzer.AdvertisementPatternAnalyzer;
import de.airgalaxie.veloairchat.moderation.analyzer.CapsAnalyzer;
import de.airgalaxie.veloairchat.moderation.analyzer.DuplicateAnalyzer;
import de.airgalaxie.veloairchat.moderation.analyzer.FloodAnalyzer;
import de.airgalaxie.veloairchat.moderation.analyzer.UrlAnalyzer;
import de.airgalaxie.veloairchat.placeholders.DefaultReplacer;
import de.airgalaxie.veloairchat.placeholders.PlaceholderReplacer;
import de.airgalaxie.veloairchat.placeholders.VelocityPlaceholderApiBridge;
import de.airgalaxie.veloairchat.security.VelocityChatAuditSigner;
import de.airgalaxie.veloairchat.channel.Channel;
import de.airgalaxie.veloairchat.user.OnlineUser;
import de.airgalaxie.veloairchat.user.UserCache;
...
public class VelocityVeloAirChat implements VeloAirChat, VelocityEventProvider {
    ...
    private ChatModerationPipeline moderationPipeline;
    ...
    public void onProxyInitialization(@NotNull ProxyInitializeEvent event) {
        ...
        this.moderationPipeline = new ChatModerationPipeline(
                new CompositeChatAnalyzer(List.of(
                        new DuplicateAnalyzer(),
                        new FloodAnalyzer(),
                        new CapsAnalyzer(),
                        new UrlAnalyzer(),
                        new AdvertisementPatternAnalyzer()
                )),
