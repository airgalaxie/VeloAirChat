...
Security fixes are provided for the latest published VeloAirChat release.
Pre-release versions are supported on a best-effort basis.
...
Never include server credentials, player personal data or private signing
